...
STORY = {
    "enemies": {
        ...
        "682": dict(name=L("SCP-682", "SCP-682"), tag=L("Keter · Hard-to-Destroy Reptile", "Keter · Reptil Difícil de Destruir"), sprite="scp682",
                    hp=260, atk=24, def_=14, flee=0.0, immune=True,
                    immune_text=L("The wound closes before your eyes. It is learning.", "La herida se cierra ante tus ojos. Está aprendiendo."), bg="#1a2410", cry="682_roar", music="chase",
                    ...
                    special=dict(label=L("Open the HCl valves", "Abrir las válvulas de HCl"), cond="item:hcl",
                                 text=L("You slam the injector into the valve port. Hydrochloric acid floods the chamber and it drags 682 down, thrashing.", "Clavas el inyector en la válvula. El ácido clorhídrico inunda la cámara y arrastra a 682 hacia abajo, revolviéndose."),
                                 dmg_pct=1.0, ends=True, event_flag="682_acid")),
    },
    "voices939": [
